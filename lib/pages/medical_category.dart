...
import 'package:admin_panel/subpage/doctor_list.dart';
...
import 'package:admin_panel/subpage/add_doctor.dart';
    ...
    return Container(
      ...
      child: Container(
        ...
        child: GridView.builder(
            ...
            itemCount: StaticVariables.medicalCategoryList.length,
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () async{
        ...
        await operation.getDoctor(StaticVariables.medicalCategoryList[index]).then((value){
          Navigator.pop(context);
          Navigator.push(context, MaterialPageRoute(builder: (context) => DoctorList(category: StaticVariables.medicalCategoryList[index],)));
        },onError: (error){
          Navigator.pop(context);
        ...
        //color: Color(0xffF4F7F5),
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 7),
              Text(
                StaticVariables.medicalCategoryList[index],
