...
import 'package:admin_panel/subpage/all_article_category_page.dart';
import 'package:admin_panel/subpage/article_by_category.dart';
import 'package:admin_panel/subpage/read_article_page.dart';
...
class _BlogPageState extends State<BlogPage> {
  ...
  Widget _bodyUI(ArticleProvider articleProvider) {
    ...
    return RefreshIndicator(
      backgroundColor: Colors.white,
      onRefresh: ()async{
        await articleProvider.getAllArticle().then((value){
